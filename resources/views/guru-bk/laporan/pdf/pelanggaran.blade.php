...
<style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .total-row td { font-weight: bold; background: #f1f5f9 !important; border-top: 2px solid #334155; }
...
<div class="judul"><h2>Laporan Pelanggaran & Akumulasi Poin Siswa</h2></div>
...
<table class="info-table">
    ...
    <tr><td>Total Pelanggaran</td><td>:</td><td><strong>{{ $pelanggarans->count() }} pelanggaran</strong></td></tr>
    <tr><td>Total Poin</td><td>:</td><td><strong>{{ $pelanggarans->sum('poin') }} poin</strong></td></tr>
...
<table class="data">
    ...
    <tr>
        ...
        <td>{{ \Illuminate\Support\Str::limit($p->keterangan ?? '-', 50) }}</td>
        <td style="text-align:center;font-weight:bold;">{{ $p->poin ?? 0 }}</td>
    </tr>
    @endforeach
    <tr class="total-row">
        <td colspan="6" style="text-align:right;padding-right:10px;">Total Akumulasi Poin:</td>
        <td style="text-align:center;">{{ $pelanggarans->sum('poin') }}</td>
    </tr>
    </tbody>
</table>
@endif
