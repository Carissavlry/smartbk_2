...
<style>
    ...
    .foto-preview { width:72px; height:72px; border-radius:50%; object-fit:cover; border:2px solid #e2e8f0; background:#f1f5f9; display:flex; align-items:center; justify-content:center; overflow:hidden; flex-shrink:0; }
    ...
    .badge-nis { display:inline-flex; align-items:center; gap:6px; background:#eff6ff; color:#1d4ed8; border:1px solid #bfdbfe; border-radius:8px; padding:6px 12px; font-size:0.8rem; font-weight:600; margin-bottom:4px; }
</style>

<div class="page-header">
    <div>
        <div class="page-header__title">Edit Data Siswa</div>
        <div class="page-header__sub">Perbarui data siswa — {{ $siswa->name }}</div>
    </div>
        ...
        <div class="form-group">
            ...
            <div style="position:relative;">
                ...
                <button type="button" onclick="togglePassword()"
                    ...
                    <svg id="eyeIcon" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" style="width:18px;height:18px">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 010-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.964-7.178z"/>
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/>
                    </svg>
                </button>
            </div>
            <span class="hint">Minimal 6 karakter. Kosongkan jika tidak ingin diubah.</span>
            @error('password')<div class="error-msg">{{ $message }}</div>@enderror
        </div>

        <div class="form-group">
            <label>Email <span style="font-size:0.72rem;color:#94a3b8;">(opsional)</span></label>
            <input type="email" name="email" value="{{ old('email', $siswa->email) }}" placeholder="email@contoh.com">
...
<div class="card">
    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            ...
            <input type="text" name="tempat_lahir" value="{{ old('tempat_lahir', $siswa->tempat_lahir) }}" placeholder="Contoh: Surabaya">
            @error('tempat_lahir')<div class="error-msg">{{ $message }}</div>@enderror
        </div>

        <div class="form-group">
            <label>Tanggal Lahir</label>
            <input type="date" name="tanggal_lahir" value="{{ old('tanggal_lahir', $siswa->tanggal_lahir ? \Carbon\Carbon::parse($siswa->tanggal_lahir)->format('Y-m-d') : '') }}">
            @error('tanggal_lahir')<div class="error-msg">{{ $message }}</div>@enderror
        </div>

        <div class="form-group">
            <label>No. HP Siswa</label>
            <input type="text" name="no_hp" value="{{ old('no_hp', $siswa->no_hp) }}" placeholder="08xxxxxxxxxx">
        ...
        <div class="form-group full">
            <label>Alamat</label>
            <textarea name="alamat" placeholder="Alamat lengkap siswa">{{ old('alamat', $siswa->alamat) }}</textarea>
        ...
        <div class="form-group full">
            ...
            <div class="foto-preview-wrap">
                ...
                <div>
                    ...
                    @if($siswa->foto)
                        <div class="hint" style="margin-top:6px;">Foto saat ini tersimpan. Upload baru untuk menggantinya.</div>
                    @endif
                </div>
            </div>
...
<div class="card">
    ...
    <div class="form-grid">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_ortu" value="{{ old('nama_ortu', $siswa->nama_ortu) }}" placeholder="Nama lengkap orang tua" required>
            @error('nama_ortu')<div class="error-msg">{{ $message }}</div>@enderror
        </div>

        <div class="form-group">
            <label>No. HP Orang Tua <span class="req">*</span></label>
            <input type="text" name="no_hp_ortu" value="{{ old('no_hp_ortu', $siswa->no_hp_ortu) }}" placeholder="08xxxxxxxxxx" required>
