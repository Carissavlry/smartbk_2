...
<style>
    ...
    .btn-submit {
        ...
        cursor: pointer;
        transition: all 0.2s;
        box-shadow: 0 4px 12px rgba(117,22,46,0.2);
    }
...
<div class="page-header">
    ...
    <div>
        <div class="page-header__title">Edit Tahun Ajaran</div>
        <div class="page-header__sub">Ubah data tahun ajaran {{ $tahunAjaran->nama }}</div>
    </div>
</div>
...
<div class="form-card">
    <div class="form-card__header">
        ...
        <div>
            <div class="form-card__title">Edit Data Tahun Ajaran</div>
            <div class="form-card__sub">Perbarui informasi tahun ajaran</div>
        </div>
    </div>
    ...
    <div class="form-card__body">
        <form method="POST" action="{{ route('admin.tahun-ajaran.update', $tahunAjaran) }}">
            ...
            <div class="form-group">
                <label class="form-label" for="nama">Nama Tahun Ajaran <span>*</span></label>
                <div style="display:flex; gap:8px; align-items:center;">
                    <input type="number" id="tahun_mulai" min="2000" max="2099"
                        value="{{ old('nama', $tahunAjaran->nama) ? substr(old('nama', $tahunAjaran->nama),0,4) : '' }}"
                        placeholder="2024"
                        class="form-control"
                        style="width:120px;"
            ...
            <div class="form-grid">
                <div class="form-group">
                    <label class="form-label" for="tanggal_mulai">Tanggal Mulai <span>*</span></label>
                    <input
                        type="date"
                        id="tanggal_mulai"
                        name="tanggal_mulai"
                ...
                <div class="form-group">
                    <label class="form-label" for="tanggal_selesai">Tanggal Selesai <span>*</span></label>
                    <input
                        type="date"
                        id="tanggal_selesai"
            ...
            <div class="form-group">
                <label class="form-check" for="is_aktif">
                    <input
                        ...
                        id="is_aktif"
                        name="is_aktif"
                        {{ old('is_aktif', $tahunAjaran->is_aktif) ? 'checked' : '' }}
                    >
                    <div>
